...
const T = {
  fr: {
    ...
    addDocs: 'Ajouter docs',
    heroTitle: 'Assistant Documentation SAP',
    heroDesc: 'Posez vos questions SAP. Je réponds en me basant sur votre documentation interne et mes connaissances expertes.',
    ...
    disclaimer: "Les réponses sont basées sur votre documentation interne et les connaissances SAP. Vérifiez toujours les informations critiques.",
    newConversation: 'Nouvelle conversation',
    docCount: (n) => `${n} doc${n !== 1 ? 's' : ''} indexé${n !== 1 ? 's' : ''}`,
  },
  en: {
    allModules: 'All modules',
    addDocs: 'Add docs',
    heroTitle: 'SAP Documentation Assistant',
    heroDesc: 'Ask your SAP questions. I answer based on your internal documentation and expert knowledge.',
    ...
    disclaimer: 'Answers are based on your internal documentation and SAP expertise. Always verify critical information.',
    newConversation: 'New conversation',
    docCount: (n) => `${n} doc${n !== 1 ? 's' : ''} indexed`,
  },
}
